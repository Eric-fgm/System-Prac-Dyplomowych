...
const DropdownMenu = ({ trigger, label, items = [], bottomItem }) => {
  return (
    <DropdownMenuRoot>
      ...
      <DropdownMenuContent className="w-56" align="end" forceMount>
          ...
          <>
            <DropdownMenuLabel className="font-normal">
              <div className="flex flex-col space-y-1">
                <p className="text-sm font-medium leading-none">{label.name}</p>
        ...
        {bottomItem && (
          <>
            <DropdownMenuSeparator />
            <DropdownMenuItem onSelect={bottomItem.onSelect}>
              {bottomItem.name}
              {bottomItem.shortcut && (
